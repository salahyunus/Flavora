...
const Header = () => {
  ...
  return (
    <header className="fixed backdrop-blur-md z-50 inset-x-0 top-0 flex items-center justify-between px-4 md:px-10 py-4">
      <NavLink to={"/"} className="flex items-center justify-center gap-4">
        <img src={Logo} className="w-[8rem]" alt="loading..." />
      </NavLink>
          ...
          <>
            ...
            >
              ...
              {isMenu && (
                <motion.div
                  {...slideTop}
                  className="px-6 py-4 w-48 bg-gray-100 rounded-md shadow-md absolute top-12 right-0 flex flex-col gap-4"
                >
